...
VALUES
	...
	(35, NULL, NULL, 'Elasticsearch配置', 0),
	(36, 'elasticsearch.host', NULL, 'elasticsearch服务的地址', 35),
	(37, 'elasticsearch.port', NULL, 'elasticsearch服务的http端口', 35),
	(38, 'elasticsearch.index', NULL, '索引的名字', 35),
	(39, 'search', '0', '是否开启搜索功能（如果开启，需要额外启动一个ES服务，并填好ES相关的配置，1：开启 0：不开启）', 23);
