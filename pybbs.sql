...
VALUES
	...
	(8, '话题编辑（慎勾！不是自己的话题也可以编辑）', 'topic:edit', 2, '/topic/*/edit'),
	...
	(26, '删除所有索引', 'index:deleteAll', 24, '/admin/indexed/deleteAll'),
	(27, '话题置顶', 'topic:top', 2, '/topic/*/top'),
	(28, '话题加精', 'topic:good', 2, '/topic/*/good');
...
INSERT INTO `pybbs_user` (`id`, `email`, `in_time`, `password`, `signature`, `url`, `username`, `avatar`, `block`, `token`)
VALUES
	(1,'liygheart@qq.com','2016-09-09 09:50:14','$2a$10$KkUG107R3ASTHfAHei.bweXWXgCa4cE1KhK.F0odzfE0r97aeeTXC','hello world','https://tomoya92.github.io','tomoya','http://localhost:8080/static/images/upload/avatar/default.png', 0, 'd20b9a5c-8693-41a6-8943-ddb2cb78eebd');
