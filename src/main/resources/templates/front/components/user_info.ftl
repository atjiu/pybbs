<div class="panel panel-default">
  <div class="panel-body">
    <div class="media">
      <div class="media-left">
        <a data-pjax href="/user/${_user.username!}">
          <img src="${_user.avatar!}" title="${_user.username!}" class="avatar"/>
        </a>
      </div>
      <div class="media-body">
        <div class="media-heading">
          <a data-pjax href="/user/${_user.username!}">${_user.username!}</a>
  ...
  <div class="panel-footer" style="background-color: white">
    <div class="row">
      <span class="col-md-6"><a data-pjax href="/notifications"><span id="n_count">0</span> 条未读消息</a></span>
      <span class="col-md-6 text-right">积分：<a data-pjax href="/top100">${_user.score!0}</a></span>
      <#--如果没有开启socket通知，则继续使用轮询的方式-->
      <#if site.socketNotification == "1">
        <script>
