  ...
  <div class="col-md-9">
    <div class="panel panel-default">
      <div class="panel-heading">
        <a href="/"><@spring.message "site.panel.header.home"/></a> / <@spring.message "site.panel.header.createTopic"/>
      </div>
      <div class="panel-body">
        <form method="post" action="/topic/save" id="topicForm">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="<@spring.message "site.form.topic.title"/>">
          </div>
          <div class="form-group">
            <label for="title"><@spring.message "site.form.topic.content"/></label>
            <textarea name="content" id="content" rows="15" class="form-control" placeholder="<@spring.message "site.form.topic.content"/>"></textarea>
          </div>
          <div class="form-group">
