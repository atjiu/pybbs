<div class="panel panel-info hidden" id="email_forget_password_div">
  ...
  <div class="panel-body">
    <form action="" onsubmit="return;">
      ...
      <div class="form-group">
        <button type="button" id="email_forget_password" onclick="email_forget_password()" class="btn btn-info">找回密码</button>
        <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="手机号登录系统会判断手机号是否注册过，如果没有注册过，会创建帐号"></i>
      </div>
    </form>
