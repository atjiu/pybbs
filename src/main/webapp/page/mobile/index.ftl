...
<div class="panel panel-default">
            ...
            <td>
                ...
                <span style="display: block;color:#ccc;padding:3px 0 3px 0">
                    ...
                    <span style="display: inline-block; float: right;">
                        ${topic.formatDate(topic.last_reply_time)!}
                    </span>
                </span>
            </td>
        </tr>
    ...
    <#include "/page/mobile/common/_paginate.ftl"/>
    <@paginate currentPage=page.pageNumber totalPage=page.totalPage actionUrl="${baseUrl!}/" urlParas="&tab=${tab!}" />
</div>
<div class="panel panel-default">
