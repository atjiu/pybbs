...
<div class="panel panel-default">
  <div class="list-group">
    ...
    <a href="/user/setting/accessToken" class="list-group-item <#if setting_menu_tab == 'accessToken'>active</#if>">用户令牌</a>
    <a href="/user/setting/log" class="list-group-item <#if setting_menu_tab == 'log'>active</#if>">日志记录</a>
  </div>
</div>
</#macro>