...
<ul class="pagination pagination-sm <#if totalPage == 1>hidden-xs hidden-sm hidden-md hidden-lg</#if>">
  ...
  <#if (currentPage == 1)>
    <!--<li>上页</li>-->
  <#else>
    <li><a data-pjax href="${actionUrl}?p=1${urlParas!}">&lt;&lt;</a></li>
    <li><a data-pjax href="${actionUrl}?p=#{currentPage - 1}${urlParas!}">&lt;</a></li>
  </#if>
  ...
  <#list startPage..endPage as i>
    ...
    <#else>
      <li><a data-pjax href="${actionUrl}?p=#{i}${urlParas!}">#{i}</a></li>
    </#if>
  </#list>
  ...
  <#else>
    <li><a data-pjax href="${actionUrl}?p=#{currentPage + 1}${urlParas!}">&gt;</a></li>
    <li><a data-pjax href="${actionUrl}?p=#{totalPage}${urlParas!}">&gt;&gt;</a></li>
  </#if>
</ul>
</#macro>