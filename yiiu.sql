...
INSERT INTO `yiiu_node` (`id`, `in_time`, `intro`, `name`, `pid`, `topic_count`, `value`)
VALUES
  (1, '2017-10-18 14:32:37', '', '分享', 0, 0, ''),
  (2, '2017-10-18 14:35:05', '', '分享', 1, 0, 'share'),
  (19, '2017-10-18 14:43:18', '', '博客', 1, 0, 'blog'),
  (20, '2017-10-18 14:48:49', '', '游戏', 0, 0, ''),
  (21, '2017-10-18 14:50:37', '', '英雄联盟', 20, 0, 'lol'),
  (22, '2017-10-18 14:50:48', '', '饥荒', 20, 0, 'dont_starve'),
  (23, '2017-10-18 14:50:57', '', '泰拉瑞亚', 20, 0, 'terraria'),
  (24, '2017-10-18 14:51:05', '', '我的世界', 20, 0, 'minecraft'),
  (25, '2017-10-18 14:51:13', '', '星露谷物语', 20, 0, 'stardew_valley'),
  (26, '2017-10-18 14:56:05', '', '编程语言', 0, 0, ''),
  (27, '2017-10-18 17:52:47', '', 'Java', 26, 0, 'java'),
  (28, '2017-10-18 17:53:04', '', 'Spring-Boot', 26, 0, 'spring_boot'),
  (29, '2017-10-18 17:55:46', '', 'Bootstrap', 26, 0, 'bootstrap');

INSERT INTO `yiiu_user` (`id`, `attempts`, `attempts_time`, `bio`, `block`, `email`, `in_time`, `password`, `score`, `space_size`, `token`, `url`, `username`, `avatar`)
VALUES
  (1, 0, '2017-10-25 10:02:24', 'hello world', 0, 'liygheart@qq.com', '2016-09-09 09:50:14', '$2a$10$KkUG107R3ASTHfAHei.bweXWXgCa4cE1KhK.F0odzfE0r97aeeTXC', 2000, 50, 'd20b9a5c-8693-41a6-8943-ddb2cb78eebd', 'https://tomoya92.github.io', 'tomoya', 'http://localhost:8080/static/images/upload/tomoya/avatar.png');
